...
const categories = [
  ...
  },
  {
    title: "Entrées",
    items: [
      { name: "Entrée du jour", price: "None" },
      { name: "Otsukuri Sashimi", price: "None" },
    ],
  },
  {
    title: "Plats",
    items: [
      { name: "Viande du jour", price: "None" },
      { name: "Poisson du jour", price: "None" },
      { name: "Nigiri-Sushi", price: "None" },
    ],
  },
  {
    title: "Desserts",
    items: [
      { name: "Dessert du jour", price: "None" },
    ],
  },
];
